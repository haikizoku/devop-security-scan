...
def top_port_scan(target) :
    ...
    return(results_top_port_scan_json)    #json.dumps convert into json
...
def os_detection(target) :
    ...
    return(results_os_detection_json ) #MUST BE ROOT
